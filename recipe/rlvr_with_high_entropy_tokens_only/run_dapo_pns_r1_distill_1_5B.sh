...
# DAPO + PNS_RLVR: DeepSeek-R1-Distill-Qwen-1.5B on 4x H100 (80GB) GPUs
#
# DAPO 训练 + 真正 PNS 干预:
#   - 所有 response token 正常参与 DAPO policy loss
#   - PNS 在 advantage 计算之后，对高熵步骤做 counterfactual ablation
#   - PNS bonus 加性注入 advantage
#
# 与 DAPO baseline 的区别: 启用 PNS (pns_rlvr_enable=True)
#
...
project_name='DAPO'
exp_name='RLVR-R1-Distill-1.5B-DAPO-PNS'
